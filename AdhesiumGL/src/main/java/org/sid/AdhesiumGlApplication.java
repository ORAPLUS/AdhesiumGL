...
public class AdhesiumGlApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Role roleAdmin = new Role("ADMIN", 1, superAdmin.getId_user(), new Date(), null, null);
		roleRepository.save(roleAdmin);
		Role roleUser = new Role("USER", 1, superAdmin.getId_user(), new Date(), null, null);
		roleRepository.save(roleUser);
		Privilege privilegeI = new Privilege(superAdmin.getId_user(), new Date(), null, null, superAdmin, roleAdmin);
		Privilege privilegeII = new Privilege(superAdmin.getId_user(), new Date(), null, null, superAdmin, roleUser);
		...
		Client client = new Client("ALTRAN", "0675106030", "0522221080", "sis.ayoub.youb@gmail.com", 
								  ...
								  superAdmin.getId_user(), new Date(), null, null);
		clientRepository.save(client);
		Produit produit1 = new Produit("MD2", superAdmin.getId_user(), new Date(), null, null);
		produitRepository.save(produit1);
		Produit produit2 = new Produit("ZAD", superAdmin.getId_user(), new Date(), null, null);
		produitRepository.save(produit2);
		Produit produit3 = new Produit("HD2", superAdmin.getId_user(), new Date(), null, null);
		produitRepository.save(produit3);
		Produit produit4 = new Produit("MD2", superAdmin.getId_user(), new Date(), null, null);
